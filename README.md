# Zero-to-AGI
Starting my journey from scratch to becoming a Future AGI++ Developer. I’m committed to researching deeply, coding daily, and building AI that changes the world. Follow my daily updates right here!

#Day1 #QuestionsPractice

1. Personal Identity Dashboard
This script manages your profile and calculates your coding journey using basic subtraction.
2. Simple Grocery Bill
Uses float data types to handle currency and discounts.
3. Square and Cube Calculator
Demonstrates the exponentiation operator ** used in AI math.
4. Custom Welcome Banner
Uses string repetition * to create visual dividers.
5. Age in Months and Days
Multiplication used to derive new features from a base variable.
6. Divisibility Checker
Uses the modulus operator % to find the remainder.
7. Rectangle Area & Perimeter
Focuses on operator precedence and the use of parentheses ().
8. Salary Splitter
Shows the difference between floor division // and modulus %.
9. String Joiner
Demonstrates string concatenation with a manual space.
10. Data Type Auditor
